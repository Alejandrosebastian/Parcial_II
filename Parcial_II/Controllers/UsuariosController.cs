...
namespace Parcial_II.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Usuario.Include(u => u.Rol);
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,Usuarios,Clave,RolId")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioId,Usuarios,Clave,RolId")] Usuario usuario)
        {
